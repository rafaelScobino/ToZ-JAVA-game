...
public class HeroCreateMechanics {
    ...
    public static void setClassDisplay(HeroCreationScreen hcs){
        switch (classSelected) {
            case "warrior":
                hcs.heroImg.setIcon(new ImageIcon(HeroCreationScreen.class.getResource("/hero/warrior/idle.gif")));
                ...
                break;
            case "wizard":
                hcs.heroImg.setIcon(new ImageIcon(HeroCreationScreen.class.getResource("/hero/wizard/idle.gif")));
                ...
                break;
            case "ranger":
                hcs.heroImg.setIcon(new ImageIcon(HeroCreationScreen.class.getResource("/hero/ranger/idle.gif")));
                ...
                break;
            case "fighter":
                hcs.heroImg.setIcon(new ImageIcon(HeroCreationScreen.class.getResource("/hero/fighter/idle.gif")));
