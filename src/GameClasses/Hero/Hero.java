...
//        JOptionPane.showMessageDialog(null,"Tower Climb Started!! Good Luck");
    ...
    public  Integer heroActionSelect(BattleScreenO tower){
    ...
    public void  mgkCure(BattleScreenO tower){
        ...
        BattleInterfaceMechanics.updateEsHeroLifeHeal(tower,this.life);
        this.life = this.life + 10;
        BattleInterfaceMechanics.updateHeroLife(tower,this.life);
    }

    public Integer heroRoll(BattleScreenO tower){
        Integer rollValue;
        ...
        switch (heroActionSelect(tower)){
            case 1:
               ...
               this.setCurrentAtkType(1);
                break;
            case 2:
                Mechanics.heroImgSetter(tower,this.animations[8]);
        ...
        GameConsole.warningSetter(tower,"Your Action: " + rollValue);
        return rollValue;
    }
