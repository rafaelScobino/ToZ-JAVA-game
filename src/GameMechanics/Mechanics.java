...
//            default -> new Custom();
    ...
    public static void heroImgSetter(BattleScreenO tower, String url){
        BattleScreenO.updateHeroImg(tower,url);
    }

    public static void enemyImgSetter(BattleScreenO tower, String url){

        BattleScreenO.updateEnemyImg(tower,url);
