...
import static GameGUI.InterfaceMechanics.BattleInterfaceMechanics.updateEsHeroLife;
...
//    }
    ...
    public static void  clash(BattleScreen tower, Hero hero, Enemy enemy) {
        ...
        if (hero.getCurrentAtkType() == 1 || enemy.getCurrentAtkType() == 1) {
            ...
            if (yourRoll == theirRoll) {
                ...
                JOptionPane.showMessageDialog(tower, "Missed Or Defended");
    ...
    public static boolean gameOver(BattleScreen tower, Hero hero, Enemy enemy, Integer turn) {
        if (turn >= 30) {
            javax.swing.SwingUtilities.invokeLater(() -> {
